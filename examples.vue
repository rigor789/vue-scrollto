<template>
    <div class="Index">
        ...
        <p class="center">
            ...
            <button v-scroll-to="{ el: '#element', easing: [.6, -.80, .30, 1.9], duration: 2000 }">Scroll down with
                custom easing
            </button>
            <button v-scroll-to="{ el: '#element', offset: 200 }">Scroll down with offset</button>
            <button v-scroll-to="{ el: '#element', onDone: onDone, onCancel: onCancel }">Scroll callbacks</button>
        </p>
        ...
        <div id="container">
            <p class="center">
                <button v-scroll-to="{ el: '#container-element', container: '#container' }">Scroll inside different
                    containers
                </button>
            </p>
            <p>
            ...
            <h1 id="container-element">Hi there...</h1>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                ex
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onCancel() {
                alert('Scrolling has been interrupted...')
            }
        }
    }
</script>
